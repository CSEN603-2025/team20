...
export default function SCADDashboard() {
  ...
  const openCompanyModal = c => { setCompanyModalData(c); setCompanyModalVisible(true); };

  const [internModalVisible, setInternModalVisible] = useState(false);
  const [internModalData, setInternModalData] = useState(null);
  const openInternModal = i => { setInternModalData(i); setInternModalVisible(true); };

  const [studentModalVisible, setStudentModalVisible] = useState(false);
  const [studentModalData, setStudentModalData] = useState(null);
  const openStudentModal = s => { setStudentModalData(s); setStudentModalVisible(true); };

  const [reportModalVisible, setReportModalVisible] = useState(false);
  const [reportModalData, setReportModalData] = useState(null);
  const openReportModal = r => { setReportModalData(r); setReportModalVisible(true); };
    ...
    <div className={`scad-wrapper${isCollapsed ? " collapsed" : ""}`}>
      <aside className={`sidebar-dark${isCollapsed ? " collapsed" : ""}`}>
        ...
        {panels.map(p => (
          <button
            key={p.key}
            className={`sidebar-item${activePanel === p.key ? " active" : ""}`}
            onClick={() => {
        ...
        <div className="dashboard-content">
          ...
          {activePanel === "pending" && (
            <div className="cards-panel narrow-cards">
              ...
              {dropdownOpen && (
                <div className="facet-dropdown" ref={dropdownRef}>
                ...
                {visiblePending.map(c => (
                  <div key={c.email} className="card">
                    ...
                    <div className="card-actions">
                      ...
                      <button className="view-btn" onClick={() => openCompanyModal(c)}>
                        View Details
                      </button>
                    </div>
                  </div>
          ...
          {activePanel === "accepted" && (
            <CompanyList title="Accepted" data={acceptedCompanies} />
          )}
          {activePanel === "rejected" && (
            <CompanyList title="Rejected" data={rejectedCompanies} />
          )}
              ...
              <div className="cards-list">
                {visibleInternships.map((i, idx) => (
                  <div key={idx} className="card">
                    ...
                    <div className="card-actions">
                      <button className="view-btn" onClick={() => openInternModal(i)}>
                        View Details
                      </button>
                      <button
                        className={`view-btn ${selectedInternships.has(i.company) ? "selected" : ""}`}
          ...
          {activePanel === "reports" && (
            <div className="cards-panel narrow-cards">
              <div className="search-wrapper">
                ...
                <button className="filter-btn" onClick={generateStatisticsReport}>Statistics Report</button>
                <button className="filter-btn" onClick={generateStatistics}>Generate Statistics</button>
              </div>
              ...
              <div className="cards-list">
                {filteredReports.map(r => (
                  <div key={r.id} className="card">
                    ...
                    <div className="card-actions">
                      <a href={r.fileUrl} download className="download-btn">Download</a>
                      <button className="view-btn" onClick={() => openReportModal(r)}>
                        View Internship Report
                      </button>
                      <button className="view-btn" onClick={() => openEvaluationModal(r)}>
          ...
          {videoCallModalVisible && (
            <Modal onClose={() => setVideoCallModalVisible(false)}>
          ...
          {callUIVisible && (
            <Modal onClose={() => setCallUIVisible(false)}>
          ...
          {endedCallModalVisible && (
            <Modal onClose={() => setEndedCallModalVisible(false)}>
          ...
          {notificationsModalVisible && (
            <Modal onClose={() => setNotificationsModalVisible(false)}>
              <h3>Notifications</h3>
              ...
              <div style={{ textAlign: "right", marginTop: 12 }}>
                <button className="filter-btn" onClick={() => setNotificationsModalVisible(false)}>
                  Close
                </button>
              </div>
            </Modal>
            ...
            <div className="cards-panel narrow-cards">
              <div className="card" style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
                <div style={{ position: "relative" }}>
                  <button className="filter-btn" onClick={() => setShowStudentStartPicker(s => !s)}>
                    Start Cycle
                  </button>
                ...
                <div style={{ position: "relative" }}>
                  <button className="filter-btn" onClick={() => setShowStudentEndPicker(s => !s)}>
                    End Cycle
                  </button>
                ...
                <button className="filter-btn" onClick={() => setActivePanel("allStudents")}>
                  All Students
                </button>
                <button className="filter-btn" onClick={() => setActivePanel("reports")}>
                  Submitted Reports
                </button>
              </div>
          ...
          {activePanel === "allStudents" && (
            <div className="cards-panel narrow-cards">
              <div className="search-wrapper" style={{ marginBottom: 16, display: 'flex', gap: 8 }}>
                <button
                  className="filter-btn"
                ...
                {students
                  ...
                  .map(s => (
                    <div key={s.id} className="card">
                      ...
                      <button className="view-btn" onClick={() => openStudentModal(s)}>
                        View Details
                      </button>
                    </div>
                  ))
              ...
              <div className="cards-list">
                <div className="card">
                  <div style={{ display: 'flex', justifyContent: 'space-around', padding: '16px' }}>
                    ...
                    <button className="filter-btn" onClick={handleViewAppointments}>
          ...
          {viewAppointmentsVisible && (
            <Modal onClose={() => setViewAppointmentsVisible(false)}>
              ...
              <div style={{ textAlign: "right", marginTop: 12 }}>
                <button className="filter-btn" onClick={() => setViewAppointmentsVisible(false)}>
                  Close
                </button>
              </div>
            </Modal>
          ...
          {appointmentModalVisible && (
            <Modal onClose={() => setAppointmentModalVisible(false)}>
              {selectedAppointment ? (
                <>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 16 }}>
                    <button className="filter-btn" onClick={handleAccept}>Accept</button>
                    <button className="filter-btn" onClick={handleReject}>Reject</button>
                  </div>
                </>
              ) : (
                <>
          ...
          {requestModalVisible && (
            <Modal onClose={() => setRequestModalVisible(false)}>
          ...
          {pendingRequestsModalVisible && (
            <Modal onClose={() => setPendingRequestsModalVisible(false)}>
              <h3>Pending Appointments</h3>
              <ul>
                {appointmentRequests
          ...
          {videoNotifVisible && (
            <Modal onClose={() => setVideoNotifVisible(false)}>
          ...
          {activePanel === "workshops" && (
            <div className="cards-panel narrow-cards">
              ...
              {workshopModalVisible && (
                <Modal onClose={closeWorkshopModal}>
          ...
          {companyModalVisible && companyModalData && (
            <Modal onClose={() => setCompanyModalVisible(false)}>
          ...
          {internModalVisible && internModalData && (
            <Modal onClose={() => setInternModalVisible(false)}>
          ...
          {studentModalVisible && studentModalData && (
            <Modal onClose={() => setStudentModalVisible(false)}>
...
function CompanyList({ title, data }) {
  return (
    <div className="cards-panel narrow-cards">
      <div className="cards-list">
        {data.map(c => (
